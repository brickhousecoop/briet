  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <p><strong>Librarians: please buy, preserve and lend these ebooks!</strong> If your institution is a signatory to the <Link href="https://controlleddigitallending.org/statement">Position Statement</Link> on Controlled Digital Lending (CDL), you can buy permanent digital media at <span className="logo">BRIET</span>. <Link href="https://controlleddigitallending.org/faq/">Learn more about CDL</Link> and see the <Link href="https://controlleddigitallending.org/ill-signatories/">list of CDL signatories</Link>.</p>

        <p><strong>Readers, students, and friends: <span className="logo">BRIET</span> is for libraries.</strong> Ask your librarian to get in touch with us!</p>

        <p><strong>Prohibition on Generative AI Training Uses:</strong> <span className="logo">BRIET</span> will not make any of the books in our care available for purposes of training artificial intelligence technologies.</p>

        <p><strong>Some technical details:</strong> <span className="logo">BRIET</span> is a free and open platform for the acquisition of ebooks and other digital works by libraries that practice CDL. <span className="logo">BRIET</span> is built on the <Link href="https://specs.opds.io/opds-1.2">Open Publication Distribution System</Link> (OPDS) data standard, following the model of BookServer, an open architecture led by the Internet Archive. <span className="logo">BRIET</span> ebooks include full metadata in the OPDS catalog format.</p>

        <p><span className="logo">BRIET</span> was made possible by generous gifts from the <Link href="https://archive.org/details/kahleaustinfoundation">Kahle-Austin Foundation</Link>, and <Link href="https://www.grantfortheweb.org">Grant for the Web</Link>.</p>
